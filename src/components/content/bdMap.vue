<template>
  ...
  >
    ...
    <bm-marker
      ...
      :dragging="false"
      :icon="{url: 'https://cdn-1.baidu.com/baidu-miniprogram/static/imgs/icon-popup-map-weizhi@1x.png', size: {width: 28, height: 36}}"
    ></bm-marker>
    <!-- 周边检索 -->
    <bm-marker
    ...
    <bm-info-window
      class="map-info"
      :position="{lng: infoWindow.location.lng, lat: infoWindow.location.lat}"
    ...
    >
      <!-- 弹窗图标/题目/距离/地址 -->
      <img
        src="https://cdn-1.baidu.com/baidu-miniprogram/static/imgs/icon-xiangqing-list-transit-selected@2x.png"
      />
...
export default {
  ...
  data() {
    return {
      ...
      iconUrl: {
        bus:
          "https://cdn-1.baidu.com/baidu-miniprogram/static/imgs/icon-xiangqing-list-transit-selected@2x.png",
        metro:
          "https://cdn-1.baidu.com/baidu-miniprogram/static/imgs/icon-xiangqing-list-metro-selected@2x.png",
        aducate:
          "https://cdn-1.baidu.com/baidu-miniprogram/static/imgs/icon-xiangqing-list-education-selected@2x.png",
        medical:
          "https://cdn-1.baidu.com/baidu-miniprogram/static/imgs/icon-xiangqing-list-hospital-selected@2x.png",
        living:
          "https://cdn-1.baidu.com/baidu-miniprogram/static/imgs/icon-xiangqing-list-middle school-selected@2x.png"
      },
      // 当前选中item
      activeName: "",
      // 图标信息
    ...
    getMapAround(val) {
      ...
      let ctx = this,
        ...
        parme = {
          ...
          radius: 1000,
          output: "json",
          ak: "4NTkMmed506RZVDY1WC0zFb2imPGyES3",
          page_size: 50
        };
      ...
      //   API.getMapAround(parme).then(function(result) {
      //     ctx.pointList = result.results;
      //     for (let item of ctx.pointList) {
      //       let tag = JSON.parse(JSON.stringify(item.location));
      //       let center = JSON.parse(JSON.stringify(ctx.nearby.center));
