    ...
    <template>
      <div class="table">
        <el-table ref="OrderTable" v-loading="loading" :data="resultList">
          ...
          <el-table-column prop="qfLyjMergedCount" :label="labelName.qfLyjMergedCount"></el-table-column>
          <el-table-column prop="qfZyMergedCount" :label="labelName.qfZyMergedCount"></el-table-column>
          ...
          <el-table-column prop="qfMergedCount" :label="labelName.qfMergedCount"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getListData(val) {
      ...
      API.getLStatistic(val).then(function(result) {
        if (result.data) {
